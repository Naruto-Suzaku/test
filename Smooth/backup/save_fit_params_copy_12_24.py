...
class free_free(object):
    ...
    def curve_fit_for_Anu(self):
        ...
        result, pcov = optimize.curve_fit(func, xyz[:,:2], xyz[:,2], guess,sigma = xyz[:,2], bounds=(np.array([0]),np.array([1e10])), method='trf')
    ...
    def model_m3(self,l,b,abcz0,form='two_componant'):
