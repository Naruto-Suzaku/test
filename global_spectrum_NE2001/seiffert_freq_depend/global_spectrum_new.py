...
class absorption_JRZ(object):
    ...
    def critical_distance(self,l,b,delt_m,params):
        ...
        value = 0.5*self.Quad(self._new, 0, 50,args=(l,b,delt_m,params)) 
        def func(x,l,b,delt_m,params):
            return self.Quad(self._new, 0, x,args=(l,b,delt_m,params)) - value
        sol = so.fsolve(func,25,args=(l,b,delt_m,params))
        print 'begin_crital', 0.5*self.Quad(self._new, 0, 50,args=(l,b,delt_m,params))/value,'end_critical','sol0',sol[0] 
        return sol[0]
...
if __name__ == '__main__':
    ...
    for v in [3]:
        ...
        cla = absorption_JRZ(v = v, nside = nside, clumping_factor = 1., index_type = 'freq_dependence_index_minus_I_E', distance = dist, test = False, emi_form  = 'exp',I_E_form = 'seiffert_freq_depend',R0_R1_equal=True,using_raw_diffuse = False,only_fit_Anu = False)
        cla.mpi()
